#installed axlxs gem and nokogiri gem
#pulled article content from feedzilla.json and slashdot.xml
#used the following code to parse data and create new files
